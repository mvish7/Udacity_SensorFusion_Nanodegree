...
class matrix:
    ...
    def zero(self, dimx, dimy):
        """
        sets each elements of a matrix to zero
        :param dimx:
        :param dimy:
        :return:
        """
    ...
    def __sub__(self, other):
        """
        performs subtraction operation over matrices
        :param other:
        :return:
        """
        # check if correct dimensions
...
def kalman_filter(x, P, measurements, H, R, F, u):
...
def main():
    ...
    print(kalman_filter(x, P, measurements, H, R, F, u))
